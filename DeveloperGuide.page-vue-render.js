...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add a new contact by providing a name, phone number, email, job code, and tag.")])]),_v(" "),_c('li',[_c('p',[_v("System validates the provided input.")])]),_v(" "),_c('li',[_c('p',[_v("System checks if the contact already exists (name + phone number or email).")])]),_v(" "),_c('li',[_c('p',[_v("System adds the contact to the system and displays a confirmation message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The provided input is invalid (e.g., invalid phone number format, name too long).")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. System shows an error message and prompts the user to correct the input.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("3a. A duplicate contact is found (same name and phone number/email).")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. System displays a duplicate contact error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to delete a specific contact by name. Phone number or email is optional.")])]),_v(" "),_c('li',[_c('p',[_v("System validates the provided input.")])]),_v(" "),_c('li',[_c('p',[_v("System checks if the contact exists (name + phone number or email).")])]),_v(" "),_c('li',[_c('p',[_v("System deletes the contact and displays a confirmation message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The provided input is invalid (e.g., invalid phone number format, name too long).")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. System shows an error message and prompts the user to correct the input.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("3a. No contact matches the provided identifier.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. System shows an error message and prompts the user to correct the input an existing contact.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("3b. Multiple contacts with the same name are found. This only happens if phone number and email are not provided by user.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3c1. System asks the user to provide additional details (phone number or email) to specify the contact to delete.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('h4',{attrs:{"id":"uc004-filter-contacts"}},[_c('strong',[_v("UC004: Filter contacts")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#uc004-filter-contacts","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to filter contacts by job code or tag.")])]),_v(" "),_c('li',[_c('p',[_v("System validates the filter criteria.")])]),_v(" "),_c('li',[_c('p',[_v("System retrieves and displays the filtered contacts matching the job code or tag.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The filter criteria are invalid (e.g., tag not recognized or job code too long).")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. System shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Private contact detail")]),_v(": A contact detail that is not meant to be shared with others")]),_v(" "),_c('li',[_c('strong',[_v("Contact")]),_v(": An entry in Talentcy address book that contains information about a particular person such as name, phone number, email address, and any other relevant details")]),_v(" "),_c('li',[_c('strong',[_v("Command")]),_v(": A specific text-based instruction given by the user to the system to perform a particular action (e.g., add NAME p/PHONE_NUMBER e/EMAIL j/JOB_CODE_APPLIED_FOR t/TAG is a command to add a contact to the address book)")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Wed, 2 Oct 2024, 23:39:01 GMT+8]")])])])}
}];
